...
_G.packer_plugins = {
  ...
  colorschemes = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/kevin/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
